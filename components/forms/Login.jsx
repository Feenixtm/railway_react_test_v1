...
const Login = () => {
    ...
    const submitLoginForm = async (e) => {
        ...
        try {
            const response = await fetch("https://railwaybackendtestv1-production.up.railway.app/login", {
                method: "POST",
                headers: {
            ...
            console.error("A fatal error has occurred during the login process: " + error);
        }
    }

    return (
        <div className='flex flex-col gap-4 border p-4 w-fit'>
            <h1 className='text-center text-[1.25rem] font-bold'>Login</h1>
